			...
			<Body style={main}>
				<Container style={container}>
					<Section style={message}>
						<Img src={`${baseUrl}/step-3.png`} alt="Order Received" width="65" height="73" style={{ margin: "auto" }} />
					...
					<Section style={paddingY}>
						<Row>
							<Text style={{ ...footer.text, paddingTop: 30, paddingBottom: 30 }}>
								--DO NOT REPLY TO THIS EMAIL-- Please contact us if you have any questions or issues.
							</Text>
						</Row>
						<Row>
							<Text style={footer.text}>&copy; 2024 A Cool Company. All rights reserved.</Text>
						</Row>
					</Section>
				</Container>
			</Body>
