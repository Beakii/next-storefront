				...
				<MaxWidthWrapper className="pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-3 lg:pb-52 lg:pt-24 xl:gap-x-8 xl:pt-32">
					<div className="col-span-2 px-6 lg:px-0 lg:pt-4">
						<div className="relative mx-auto flex flex-col items-center text-center lg:items-start lg:text-left">
							...
							<p className="mt-8 max-w-prose text-balance text-center text-lg md:text-wrap lg:pr-10 lg:text-left">
								Your <span className="rounded-md bg-blue-300 p-1 text-white">case</span>. Your <span className="rounded-md bg-orange-300 p-1 text-white">image</span>. Your{" "}
								<span className="rounded-md bg-purple-300 p-1 text-white">style</span>. Create a custom case with your own image and make your device stand out.
							</p>
							...
							<div className="mt-12 flex flex-col items-center gap-5 sm:flex-row sm:items-start">
								<div className="flex -space-x-4">
									...
									<img src="/users/user-5.jpg" alt="user image" className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-slate-100" />
								</div>
					...
					<div className="col-span-full mt-32 flex h-fit w-full justify-center px-8 sm:px-16 md:px-0 lg:col-span-1 lg:mx-0 lg:mt-20">
						<div className="relative md:max-w-xl">
							<Image className="absolute -top-20 left-56 hidden w-40 select-none sm:block lg:hidden lg:w-52 xl:block" src="/your-image.png" height={200} width={200} alt="Guitar Pick" />
